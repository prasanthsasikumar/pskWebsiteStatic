          ...
          if (self.ishwscroll) {
            ...
            if (railh) {
            	// Lumen
			        ...
			        var lumen_bottom = 10;
			        /*
			        if(jQuery('.posts-wrapper') && jQuery('.posts-wrapper').hasClass('sidebar-open')){
				        lumen_offset = 330;
			        }
			        */
              railh.css({position:"absolute",left:0,bottom:lumen_bottom});
              // END
              //(railh.align) ? railh.css({bottom:lumen_bottom}) : railh.css({top:0});
              bd.append(railh);
            }
          } else {
...
//
    ...
    this.onResize = function(e,page) {
      ...
      // Lumen
      var lumen_offset = 60;
      self.view.w = self.view.w - lumen_offset;
      // END
